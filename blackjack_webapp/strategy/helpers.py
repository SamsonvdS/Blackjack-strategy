...
def how_to_play_hand(Deckdf, DealerCombinations, dealer_hand, player_hand):
    """returns how to play your hand against the dealer's open_card"""
    hand_decision, true_count, kelly_pct = make_decision(Deckdf, DealerCombinations, dealer_hand, player_hand)
...
def calculate_side_bets(Deckdf, DealerCombinations):
    """
    ...
    ev_bust_it, kelly_pct_bust_it = calculate_ev_bust_it(DealerCombinations)
